...
IMAGE_UTILS_NAME=ondewo-sip-client-utils-nodejs:${ONDEWO_SIP_VERSION}
PRETTIER_WRITE?=

CURRENT_RELEASE_NOTES=`cat RELEASE.md \
	| sed -n '/Release ONDEWO SIP Nodejs Client ${ONDEWO_SIP_VERSION}/,/\*\*/p'`
...
run_precommit_hooks: ## Run all Precommit Hooks
	.husky/pre-commit
...
create_npm_package: ## Creates NPM Folder
	rm -rf npm
	mkdir npm
	cp -R api npm
